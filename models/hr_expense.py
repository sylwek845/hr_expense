...
class HrExpense(models.Model):
    ...
    def message_new(self, msg_dict, custom_values=None):
       # super(HrExpRef, self).message_new( msg_dict, custom_values=None)
        ...
        if not expense_price:
            ...
            try:
                ...
                price = 1.0
        #temp1 = fields.Related('partner_id','MANY2MANY FIELD', type='many2many', relation='RELATED MODEL', string='LABEL'),

        #temp = fields.Relational("product.product",product.id)
